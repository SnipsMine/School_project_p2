...
def get_animation_data(num=0, start_frame=0, sme_pos_ethanol=((70, 0, 0), (0, 0, 0), (-70, 0, 0)),
    ...
    if num == 0:
        ...
        enzyme1 = {"name": "enzyme1",
                   "molecule": [False, Sphere([30, 0, -10], 4, Texture(Pigment("color", [1, 0, 0], "filter", 0.2),
                                                                       Finish("phong", 0.6, "reflection", 0.1))),
                                Text("ttf", '"timrom.ttf"', '"ADH"', 0.1, 0, "scale", [2, 2, 2], models.text_model,
                                     "rotate", [0, 180, 0], "translate", [32.5, -6, -10])],
        ...
        enzyme2 = {"name": "enzyme2",
                   "molecule": [False, Sphere([-30, 0, -10], 4, Texture(Pigment("color", [0, 1, 0], "filter", 0.2),
                                                                        Finish("phong", 0.6, "reflection", 0.1))),
                                Text("ttf", '"timrom.ttf"', '"ALDH"', 0.1, 0, "scale", [2, 2, 2], models.text_model,
                                     "rotate", [0, 180, 0], "translate", [-27.5, -6, -10])],
                   "keyframe_endpos_frames": [0],
                   "keyframe_endpos": [[-30, 0, -10],
                                       ],
                   }
    ...
    if num == 0:
        ...
        animation_objects = {"ethanol{}_1".format(num): ethanol1_1,
                             "water{}_1".format(num): water1_1,
                             "NAD{}_1".format(num): nad1_1,
                             "waterstof{}_1".format(num): waterstof1_1,
                             "hNAD{}_1".format(num): hnad1_1,
...
def add_multipliers(obj, frame, animation_objects, key, start_frame, ethanol_start_wacht, ethanol_mid_wacht, aldh_speed):
    """
    This adds the given frane multiplyers to the correct frame value.
    """
...
def main():
    """
    Gets the animation data and prints the data in a structured way
    """
